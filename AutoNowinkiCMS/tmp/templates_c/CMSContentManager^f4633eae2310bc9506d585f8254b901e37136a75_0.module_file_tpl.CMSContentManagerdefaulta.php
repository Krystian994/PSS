<?php
/* Smarty version 4.2.1, created on 2025-05-17 00:15:27
  from 'module_file_tpl:CMSContentManager;defaultadmin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_6827b8ffc38f91_09558742',
...
seek=' + ui.item.value;
      ...
      cms_CMloadUrl('a.page_setinactive', '<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('confirm_setinactive'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
'),
      cms_CMloadUrl('a.page_setactive'),
      cms_CMloadUrl('a.page_setdefault', '<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('confirm_setdefault'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
'),
      cms_CMloadUrl('a.page_delete', '<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('confirm_delete_page'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
...
steal=1';
          cms_confirm('<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('confirm_steal_lock'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
').done(function(){
...
/ajax_lock.php?showtemplate=false';
          ...
          $.ajax({
		      ...
		      event.preventDefault();
	              cms_alert('<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('error_contentlocked'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
                  }
              }
	  });
	 ...
	 $(map[v]).show();
      ...
      $(document).on('click', '#myoptions', function () {
	      ...
	      minHeight: 225,
              resizable: false,
              buttons: {
                  '<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('submit'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
': function () {
                      $(this).dialog('close');
                      $('#myoptions_form').submit();
                  },
                  '<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('cancel'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
': function () {
                      $(this).dialog('close');
                  },
              }
...
/ajax_lock.php?showtemplate=false';
          ...
          if( have_locks ) {
	      e.preventDefault();
              cms_alert('<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('error_action_contentlocked'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
          }
      })
  });
