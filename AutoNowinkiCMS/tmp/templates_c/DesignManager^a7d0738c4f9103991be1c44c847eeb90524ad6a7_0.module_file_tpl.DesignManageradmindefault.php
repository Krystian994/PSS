<?php
/* Smarty version 4.2.1, created on 2025-05-17 00:10:43
  from 'module_file_tpl:DesignManager;admin_defaultadmin_categories.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_6827b7e307d2c8_36927672',
...
function content_6827b7e307d2c8_36927672 (Smarty_Internal_Template $_smarty_tpl) {
...
&showtemplate=false',
    ...
    $('#categorylist a.del_cat').click(function(ev){
       var self = $(this);
       ev.preventDefault();
       cms_confirm('<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('confirm_delete_category'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
').done(function(){
