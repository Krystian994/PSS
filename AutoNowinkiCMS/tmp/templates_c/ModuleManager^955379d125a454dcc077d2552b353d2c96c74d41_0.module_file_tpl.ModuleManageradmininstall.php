<?php
/* Smarty version 4.2.1, created on 2025-05-27 14:21:56
  from 'module_file_tpl:ModuleManager;admin_installed.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_6835ae648a2e02_97868509',
...
function content_6835ae648a2e02_97868509 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\cmsms\\lib\\plugins\\function.form_start.php','function'=>'smarty_function_form_start',),1=>array('file'=>'C:\\xampp\\htdocs\\cmsms\\admin\\plugins\\function.cms_help.php','function'=>'smarty_function_cms_help',),2=>array('file'=>'C:\\xampp\\htdocs\\cmsms\\lib\\plugins\\function.form_end.php','function'=>'smarty_function_form_end',),3=>array('file'=>'C:\\xampp\\htdocs\\cmsms\\admin\\plugins\\function.admin_icon.php','function'=>'smarty_function_admin_icon',),4=>array('file'=>'C:\\xampp\\htdocs\\cmsms\\lib\\smarty\\plugins\\function.cycle.php','function'=>'smarty_function_cycle',),5=>array('file'=>'C:\\xampp\\htdocs\\cmsms\\lib\\plugins\\function.cms_action_url.php','function'=>'smarty_cms_function_cms_action_url',),));
echo '<script'; ?>
...
$(document).ready(function(){
  $('a.mod_upgrade').click( function(ev){
      ...
      cms_confirm('<?php echo strtr((string)$_smarty_tpl->tpl_vars['ModuleManager']->value->Lang('confirm_upgrade'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
').done(function(){
  ...
  $('a.mod_remove').click( function(ev){
      ev.preventDefault();
      var href = $(this).attr('href');
      cms_confirm('<?php echo strtr((string)$_smarty_tpl->tpl_vars['ModuleManager']->value->Lang('confirm_remove'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
').done(function(){
          window.location.href = href;
      })
  });
  $('a.mod_chmod').click( function(ev){
      ev.preventDefault();
      var href = $(this).attr('href');
      cms_confirm('<?php echo strtr((string)$_smarty_tpl->tpl_vars['ModuleManager']->value->Lang('confirm_chmod'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
').done(function(){
          window.location.href = href;
      })
  });
...
: function() {
          ...
          if( file.length == 0 ) {
            cms_alert('<?php echo strtr((string)$_smarty_tpl->tpl_vars['ModuleManager']->value->Lang('error_nofileuploaded'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
          }
	  else {
            var ext  = file.split('.').pop().toLowerCase();
            if($.inArray(ext, ['xml','cmsmod']) == -1) {
              cms_alert('<?php echo strtr((string)$_smarty_tpl->tpl_vars['ModuleManager']->value->Lang('error_invaliduploadtype'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
            }
	    else {
              $(this).dialog('close');
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['installed_version'];?>
      ...
      <td>          <?php $_smarty_tpl->_assignInScope('ops', array());?>
...
$_smarty_tpl->_assignInScope('tmp', ('status_').($_smarty_tpl->tpl_vars['item']->value['status']));?><span title="<?php echo $_smarty_tpl->tpl_vars['ModuleManager']->value->Lang($_smarty_tpl->tpl_vars['tmp']->value);?>
...
$_smarty_tpl->_assignInScope('ops', $_tmp_array);?>
	    <?php }?>
          ...
          <?php if ((isset($_smarty_tpl->tpl_vars['item']->value['e_status']))) {?>
            <?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', 'op', null);
$_smarty_tpl->_assignInScope('tmp', ('status_').($_smarty_tpl->tpl_vars['item']->value['e_status']));?><span <?php if ($_smarty_tpl->tpl_vars['item']->value['e_status'] == 'db_newer') {?>class="important"<?php }?> title="<?php echo $_smarty_tpl->tpl_vars['ModuleManager']->value->Lang($_smarty_tpl->tpl_vars['tmp']->value);?>
