...
function content_6827b92db1fd04_45868890 (Smarty_Internal_Template $_smarty_tpl) {
...
: <?php echo $_smarty_tpl->tpl_vars['user']->value->username;?>
					...
					<!-- bookmarks -->
					<?php
$_smarty_tpl->_subTemplateRender('file:shortcuts.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false, '2eb413b43a9f10623ed9e300f1d04e103df29709', 'content_6827b92da958b3_24399885');
?>
				</div>
				<!-- end header-bottom //-->
			</header>
...
/<?php echo lang('close');?>
 			            ...
 			            <?php
$_smarty_tpl->_subTemplateRender('file:navigation.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('nav'=>$_smarty_tpl->tpl_vars['theme']->value->get_navigation_tree()), 0, false, '38ca114c0c39558fd3047966869c5517efd28402', 'content_6827b92dac89c3_06459959');
?>
				    </aside>
				</div>
				<!-- end sidebar //-->
				...
				<div id="oe_mainarea" class="cf">
					<?php
$_smarty_tpl->_subTemplateRender('file:messages.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false, '8dbdd616b4326f61a9dc28c85ed4447facdfe5f4', 'content_6827b92daf0372_21148415');
...
"><?php echo lang('module_help');?>
			...
			<!-- start footer -->
			<?php
$_smarty_tpl->_subTemplateRender('file:footer.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false, 'a59300ec162ea4de071895327c16e869a77f968c', 'content_6827b92dafe127_91126095');
?>
			<!-- end footer //-->
...
function content_6827b92da958b3_24399885 (Smarty_Internal_Template $_smarty_tpl) {
...
function content_6827b92dac89c3_06459959 (Smarty_Internal_Template $_smarty_tpl) {
...
}?>" <?php if (substr($_smarty_tpl->tpl_vars['navitem']->value['url'],0,6) == 'logout' && (isset($_smarty_tpl->tpl_vars['is_sitedown']->value))) {?>onclick="return confirm('<?php echo strtr((string)lang('maintenance_warning'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
...
function content_6827b92daf0372_21148415 (Smarty_Internal_Template $_smarty_tpl) {
...
function content_6827b92dafe127_91126095 (Smarty_Internal_Template $_smarty_tpl) {
