<?php
/* Smarty version 4.2.1, created on 2025-05-17 00:10:41
  from 'module_file_tpl:DesignManager;admin_defaultadmin_templates.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_6827b7e103b290_85218270',
...
function content_6827b7e103b290_85218270 (Smarty_Internal_Template $_smarty_tpl) {
...
'
    ...
    $(document).on('click','a.steal_tpl_lock',function(e) {
      ...
      return confirm('<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('confirm_steal_lock'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
    });
...
');
    ...
    $(document).on('click','#tpl_bulk_submit',function() {
        var n = $('input:checkbox:checked.tpl_select').length
            if( n == 0 ) {
                cms_alert('<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('error_nothingselected'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
');
                return false;
            }
        });
...
': function () {
          ...
          '<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('reset'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
': function () {
            $(this).dialog('close');
...
<div id="filterdialog" style="display: none;" title="<?php echo strtr((string)$_smarty_tpl->tpl_vars['mod']->value->Lang('tpl_filter'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
">
